...
<body>
    <div>
        <form class='cuadrogeneral' action='<?php echo "verificadorcodigodinamico.php?id=$id&Nempresa=$Nempresa "; ?>'
            method='post'>
            ...
            <table>
                <tr>
                    <td>
                        <div class='centrar1'><img
                                src='/IMG/Image 21-2022-10-14+01_49_32.790874/Raster_9/assets/Raster.png' alt
                ...
                <TR>
                    <TD>
                        <div class='cuadro4 negro'><br>
                            <h4><strong>Codigo dinamico</strong></h4>
                        </div>
                    </TD>
                    <td>
            ...
            <br>
            <br>
            <div class='centrar1 cuadro9 text-lg-center '>
                <h4><strong>Ingrese el codigo dinamico</strong></h4>
            </div>
            ...
            <form id="form1 ">
                ...
                <div class="input-group cuadro7 negro">
                    <input type='Password' ID='txtPassword' name='codigodinamico' class='form-control'
                        placeholder='codigo dinamico...'>
                ...
                <input class='btn btn-success cuadro9' type='submit' value='Verificar'></input>
            </form>
        </form>
    </div>
