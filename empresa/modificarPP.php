...
$conn = mysqli_connect($server, $user, $password, $database);        
                ...
                $intruccion_SQL = "UPDATE productos SET N_producto = '$N_productos', Categoria = '$Categoria', Precio = '$Precio', Descripción = '$Descripcion', descuento = '$descuento', imagen1 = '$binariosImagen', imagen2 = '$binariosImagen2', imagen3 = '$binariosImagen3' WHERE id = $id";
